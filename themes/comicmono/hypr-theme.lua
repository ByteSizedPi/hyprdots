...
-- Installed by scripts/desktop-theme/apply.sh from themes/<name>/hypr-theme.lua.
...
-- resize_on_border) lives in ui.lua so swapping themes can't revert it.
-- Border COLORS come from noctalia.lua, regenerated by Noctalia per palette.
