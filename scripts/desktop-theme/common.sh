...
# GENERATED by scripts/desktop-theme/apply.sh — the '$(active_theme)' theme ships no
# $app settings. Add themes/<name>/apps/$app.conf to give a theme its own, or just
# edit this file and run: scripts/desktop-theme/save.sh <name> --force
EOF
}
